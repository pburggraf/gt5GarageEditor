...
{
    public sealed class InputBoxString : Form
    {
        ...
        public InputBoxString(string string_1, string string_2)
        {
            method_1(string.Empty);
            InitializeComponent();
            Text = string_1;
            label_prompt.Text = string_2;
        }
