    ...
    public sealed class SetUp : Form
    {
        ...
        public void method_10(CarParameterBlob blob)
        {
            try
            {
                ...
                tb_springf.Text = blob.RrTyre.ToString(CultureInfo.InvariantCulture);
        ...
        public void method_11(CarParameterBlob blob)
        {
            try
            {
                ...
                blob.SpringF=byte.Parse(tb_springf.Text);
                blob.SpringR=byte.Parse(tb_springr.Text);
                blob.AntiRollBarF=byte.Parse(tb_arbf.Text);
                blob.AntiRollBarR=byte.Parse(tb_arbr.Text);
                blob.CompF=byte.Parse(tb_compf.Text);
                blob.CompR=byte.Parse(tb_compr.Text);
                blob.ExtenF=byte.Parse(tb_extf.Text);
                blob.ExtenR=byte.Parse(tb_extr.Text);
                blob.LsdInitF=byte.Parse(tb_lsdinitf.Text);
                blob.LsdInitR=byte.Parse(tb_lsdinitr.Text);
                blob.LsdAccF=byte.Parse(tb_lsdaccf.Text);
                blob.LsdAccR=byte.Parse(tb_lsdaccr.Text);
                blob.LsdDecF=byte.Parse(tb_lsddecf.Text);
                blob.LsdDecR=byte.Parse(tb_lsddecr.Text);
                blob.FrTorque=byte.Parse(tb_frTorque.Text);
                blob.BallastKg=byte.Parse(tb_ballastkg.Text);
                blob.BallastPos=sbyte.Parse(tb_ballastPos.Text);
                blob.Bbf=byte.Parse(tb_BBf.Text);
                blob.Bbr=byte.Parse(tb_BBr.Text);
                blob.Grip=byte.Parse(tb_grip.Text);
                blob.Bhp=byte.Parse(tb_bhp.Text);
                blob.Weight=byte.Parse(tb_weight.Text);
                blob.FrTyre=byte.Parse(tb_FrTyre.Text);
                blob.RrTyre=byte.Parse(tb_RrTyre.Text);
                blob.FrRim=byte.Parse(tb_frRim.Text);
                blob.RrRim=byte.Parse(tb_RrRim.Text);
            }
            catch
            {
        ...
        public static void smethod_3(byte[] byte_1, CarParameterBlob gclass1_3)
        {
            ...
            smethod_2(byte_1, 198U, 4U, gclass1_3.UnKnown10);
            ...
            smethod_2(byte_1, 226U, 4U, gclass1_3.UnKnown3);
            smethod_2(byte_1, 230U, 4U, gclass1_3.WReduction);
            smethod_2(byte_1, 234U, 4U, gclass1_3.UnKnown4);
            smethod_2(byte_1, 238U, 4U, gclass1_3.UnKnown5);
            smethod_2(byte_1, 242U, 4U, gclass1_3.Ecu);
            smethod_2(byte_1, 246U, 4U, gclass1_3.EngineTune);
            smethod_2(byte_1, 250U, 4U, gclass1_3.Transmission);
            ...
            smethod_2(byte_1, 270U, 4U, gclass1_3.UnKnown6);
            smethod_2(byte_1, 274U, 4U, gclass1_3.Asm);
            smethod_2(byte_1, 278U, 4U, gclass1_3.Tcs);
            smethod_2(byte_1, 282U, 4U, gclass1_3.UnKnown7);
            ...
            smethod_2(byte_1, 306U, 4U, gclass1_3.UnKnown8);
            ...
            smethod_2(byte_1, 334U, 4U, gclass1_3.UnKnown9);
            ...
            smethod_0(byte_1, 394U, gclass1_3.RrTyre);
